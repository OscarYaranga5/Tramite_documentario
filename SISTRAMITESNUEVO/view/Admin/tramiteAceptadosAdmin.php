                    ...
                    <tbody id="tablaTramites">
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td><a href='../../pdf/" . htmlspecialchars($row['archivo']) . "' download class='download-link'><i class='fas fa-file-download' style='color: #1ab394; margin-right: 5px;'></i> VER</a></td>";
                            ...
                            echo "<tr><td colspan='9'>No se encontraron trámites aceptados.</td></tr>";
                        }
