                ...
                <tbody id="tablaTramites">
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo "<td><a href='../../pdf/" . htmlspecialchars($row['archivo']) . "' download class='download-link' style='display: inline-flex; align-items: center; text-decoration: none; font-weight: bold; color: #2f4050;'><i class='fas fa-file-download' style='color: #1ab394; margin-right: 6px;'></i>VER</a></td>";
                        ...
                        echo "<tr><td colspan='9'>No se encontraron trámites a subsanar.</td></tr>";
                    }
