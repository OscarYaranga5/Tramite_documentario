<?php
// Archivo: php/update_subsanar.php
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE tramites SET Estado = 'Subsanar', mensaje = ?, fecha_recepcion = NOW() WHERE codigo_tramite = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param('ss', $mensaje, $codigo_tramite);

    if ($stmt->execute()) {
        echo "Trámite subsanado con éxito.";
    } else {
